...
## Author Notes
Chronos relies on the engine folder called ChronosEngine,
and I cannot push that folder to GitHub. I will try and
upload it to my website for your download. Thank you.
...
## Install NeoLinux
* Download "Neo_linux1.x.x" from the releases page
* Move "Neo_linux1.x.x" to a USB drive
* Download both OnnxRuntime and OnnxRuntimeGenAI
* Move the runtimes into the same USB drive
* Rename "Neo_linux1.x.x" to "Neo"
